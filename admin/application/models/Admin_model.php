<?php
  ...
  class Admin_model extends CI_Model{
    ...
    public function add_partner_social($data){
      $escape_data = $this->db->escape_str($data);
      $query = $this->db->insert('partner_social', $escape_data);
      return $query;
    }
    ...
    public function add_comment_post($community_id, $data){        
        $escape_data = $this->db->escape_str($data);
        $query = $this->db->insert('community_review', $escape_data);
        return $query;
    }
