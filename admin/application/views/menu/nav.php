        ...
        <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li><a href="<?php echo site_url('community/view'); ?>"><i class="fa fa-book"></i><span>Community</span></a></li>
                    <!--<li><a href="<?php echo site_url('dashboard/student'); ?>"><i class="fa fa-users"></i><span>Students</span></a></li>
                    <li><a href="<?php echo site_url('dashboard/profile'); ?>"><i class="fa fa-users"></i><span>Profile</span></a></li>
                    <li><a href="<?php echo site_url('dashboard/course'); ?>"><i class="fa fa-graduation-cap"></i><span>Courses</span></a></li>
                    <li><a href="<?php echo site_url('dashboard/library'); ?>"><i class="fa fa-book"></i><span>Library</span></a></li>
                    <li><a href="<?php echo site_url('dashboard/event'); ?>"><i class="fa fa-bullhorn"></i><span>Events</span></a></li>
