...
?>
<title>Admin || Edit Community || Spiela</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Community-edit">Edit Community</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="Community-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('community/edit/'.$com->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo str_replace('-', ' ', $com->title); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-12">
                                          <div class="form-group">
                                              ...
                                              <select name="category" class="form-control">
                                                 <option value="<?php echo $com->category; ?>"><?php echo str_replace('-', '', $com->category); ?></option>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Apply Job URL</label>
                                                <textarea name="applied_url" class="form-control" aria-label="With textarea"><?php echo $com->applied_url; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Meta</label>
                                                <textarea name="meta" class="form-control" aria-label="With textarea"><?php echo $com->meta; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea id="summernote" name="body" class="form-control" aria-label="With textarea"><?php echo $com->body; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form action="<?php echo base_url('community/edit_image/'.$com->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Banner <span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-right m-t-20">
                                            <button type="submit" name="submit_edit_image" class="btn btn-primary">SAVE</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
