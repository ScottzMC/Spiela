...
<?php
foreach($edit_comment as $edit_com){}

?>
<title>Admin || Edit <?php echo $edit_com->id; ?> Comments || Spiela</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                          ...
                          <li class="breadcrumb-item"><a href="<?php echo site_url('community/view_comment'); ?>">Comments</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Comments</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Community-edit">Edit Comments</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="Community-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('community/edit_comment/'.$edit_com->community_id.'/'.$edit_com->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>First Name <span class="text-danger">*</span></label>
                                                <input type="text" name="firstname" class="form-control" value="<?php echo $edit_com->firstname; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Last Name <span class="text-danger">*</span></label>
                                                <input type="text" name="lastname" class="form-control" value="<?php echo $edit_com->lastname; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Email Address <span class="text-danger">*</span></label>
                                                <input type="text" name="email" class="form-control" value="<?php echo $edit_com->email; ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Message</label>
                                                <textarea id="summernote" name="message" class="form-control" aria-label="With textarea"><?php echo $edit_com->message; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
