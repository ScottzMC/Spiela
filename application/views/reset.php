...
.menu-link{
	...
	<!-- Document Title
	============================================= -->
	<title>Reset Password || Spiela</title>
			...
			<div class="spiela-container">
                <div class="login-wrap centered">
                        <div id="normal-header">
                            ...
                            <h5 class="text-center"> Join for good reasons and benefit yourself!</h5>
                        </div>
            
            
                    <div class="d-flex justify-content-between flex-column login-snippet-wrap">
                        <div>
                            <form action="<?php echo base_url('reset_password/reset'); ?>" method="POST">
                                <div class="form-group">
                                    <label for="reset">Reset Code</label>
                                    <input type="text" class="form-control" id="email" name="code" placeholder="Enter Reset Code">
                                </div>
                                <div class="form-group">
                                ...
                                <button class="btn post-post-button" type="submit" name="reset"> Reset</button>
                            </form>
