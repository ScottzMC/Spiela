		...
		<section id="content">
			<div class="content-wrap p-0">
				<div class="container clearfix">
					...
					<ul class="clients-grid grid-3 grid-sm-3 grid-md-6 mb-0">
					    <?php if(!empty($partner)){ foreach($partner as $part){ ?>
						<li class="grid-item"><img src="https://spiela.co.uk/uploads/partners/<?php echo $part->image; ?>" alt="Clients"><a href="<?php echo site_url('partner/profile/'.$part->id); ?>" style="text-align:center;"><?php echo $part->fullname; ?></a></li>
						<?php } }else{ echo ''; } ?>
					</ul>
