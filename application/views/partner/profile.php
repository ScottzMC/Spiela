...
<head>
	...
	<title>Partner <?php echo $prof->fullname; ?> Profile || Spiela</title>
					...
					<div class="row cnt m-0">
						<div class="col-12">
							...
							<div class="feature-box fbox-lg fbox-outline fbox-dark fbox-effect">
								<div class="fbox-icon">
									<img src="https://spiela.co.uk/uploads/partners/<?php echo $prof->image; ?>" />
								</div>
								<div class="fbox-content">
									<span class="partner-desig">Partner</span>
									<div class="clear"></div>
									<span><?php echo $prof->fullname; ?></span>
									...
									<div class="col-12 col-md-7 col-lg-7">
										...
										<div class="tab-container">
											...
											<!--<div class="tab-content clearfix" id="tabs-11">
												<h3>Job Adverts</h3>
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla facilisis</p>
											</div>
