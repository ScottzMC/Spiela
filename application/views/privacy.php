		...
		============================================= -->
          ...
          <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-8">
                  <h3 class="spiela-title-heading mb-4"> Policy / Privacy Policy</h3>
                  <div class="featured-promo">
                      <div class="row">
                          <?php foreach($privacy as $priv){} ?>
                          <div class="col-12 text-left my-auto">
                              <div class="featured-promo-text-wrap mb-4 mt-4">
                                  <h4 class="promo-video-title"><?php echo $priv->title; ?></h4>
                                  <h5><?php echo $priv->body; ?></h5>
                                </div>
                          </div>
