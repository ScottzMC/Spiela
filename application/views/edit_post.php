...
<head>
	...
	<!-- Document Title
	============================================= -->
	<?php foreach($edit_post as $edt_pt){} ?>
	<?php if(!empty($edit_post)){ ?>
    <title>Edit <?php echo str_replace('-',' ',$edt_pt->title); ?> || Spiela </title>
    <?php }else{ ?>
    <title>Edit Post || Spiela </title>
    <?php } ?>
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<form action="<?php echo base_url('community/edit_post/'.$edt_pt->id); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                    <div class="new-post-snippet">
                        <div class="row ml-4">
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-4">
                                <input type="text" class="new-post-title" name="title" value="<?php echo str_replace('-', ' ', $edt_pt->title); ?>" placeholder="Add Title..."/>
                        ...
                        <div class="row ml-4">
                            <div class="col-sm-10 col-md-11 col-lg-11 col-xl-11 mt-2 mr-4 mr-md-0 mb-5">
                                <textarea id="summernote" class="new-post-textarea mb-4" name="body"  placeholder="What's on your mind?"><?php echo $edt_pt->body; ?></textarea>
                            </div>
        
                        </div>
                        <div class="row ml-4">
                            <div class="col-sm-12 col-md-4 col-lg-12 col-xl-4 mb-4">
                            <?php if($this->Data_model->isVideo($edt_pt->banner)):?>
                                <video width="100%" controls autoplay>
                                    <source src="<?php echo base_url('uploads/community/'.$edt_pt->banner); ?>" type="video/mp4">
                                    Your browser does not support the video tag.
                                </video> 
                            <?php else:?>
                                <img src="<?php echo base_url('uploads/community/'.$edt_pt->banner); ?>">
                            <?php endif;?>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-12 col-xl-4 mb-4">
                                <div>
                                    <input type="file" class="post-input" name="fileToUpload[]" value="<?php echo $edt_pt->banner; ?>">
                                </div>
