			...
			<div class="spiela-container">
                <div class="login-wrap centered">
                        <div id="normal-header">
                            <h3 class="text-center font-weight-bold"> Login to your Spiela Account</h3>
                    ...
                    <div class="d-flex justify-content-between flex-column login-snippet-wrap">
                        <div>
                            <form action="<?php echo base_url('login/test_login'); ?>" method="POST">
                                <div class="form-group">
                                    <label for="email">Email address</label>
                                    <input type="email" class="form-control" id="email" name="email" placeholder="JohnDoe@Spiela.co.uk">
                                </div>
                                <div class="form-group">
                                    <label for="password">Password</label>
                                    <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password">
                                </div>
                                <button class="btn post-post-button" type="submit" name="login"> Login</button>
                            </form>
                            <div class="col-md-6 form-input-wrapper cst mt-5 text-left position-relative" style="width: 250px; margin-left: -30px;">
                                <a href="<?php echo htmlspecialchars($fbAuthUrl); ?>" class="btn btn-primary btn-block" style="background: #3B5998;border-color: #3B5998"><i class="fab fa-facebook-square"></i> Sign In with Facebook!</a>
                            </div>
                            
                            <div class="col-md-6 form-input-wrapper cst mt-4 text-left position-relative" style="width: 250px; margin-left: -30px;">
                                <a href="<?php echo htmlspecialchars($googleAuthUrl); ?>" class="btn btn-primary btn-block" style="background: #DD4B39;border-color: #DD4B39"><i class="fab fa-google"></i> Sign In with Google!</a>
                            </div>
                            
                            <div class="col-md-12 text-center" style="">
                                <div class="mt-2">
                                    Forgot Password? <a style="color: #366e63;" href="<?php echo site_url('forgot_password'); ?>"> Click here</a>
                                </div>
                            </div>
                            <div class="col-md-12 text-center" style="margin-bottom:30px;">
                                <div class="mt-2">
                                    Create an account? <a style="color: #366e63;" href="<?php echo site_url('register'); ?>"> Register here</a>
                                </div>
                            </div>
                            <?php
