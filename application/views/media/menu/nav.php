		...
		<header id="header">
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						<div class="header-misc col-md-5">
						...
						<!-- Primary Navigation
						============================================= -->
						<nav class="primary-menu col-md-5">
			...
			<section id="filter-category">
				<div class="filter-content">
					<span class="spiela-hor-category"><img src="<?php echo base_url('images/icons/Opportunity-icon.svg'); ?>" class="icon-navbar"/> <a href="<?php echo site_url('community/category/new-job-opportunities'); ?>">OPPORTUNITY</a></span>
