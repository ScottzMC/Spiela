...
.menu-link{
	...
	<!-- Document Title
	============================================= -->
	<title>Forgot Password || Spiela</title>
		...
		============================================= -->
			...
			<div class="spiela-container">
                        <div id="normal-header">
                            <h3 class="text-center font-weight-bold"> Success</h3>
                            <h5 class="text-center"> Please check your email to reset your password.</h5>
                        </div>
