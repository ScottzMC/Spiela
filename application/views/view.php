                    ...
                    <div class="row welcome-sec">
                        ...
                        <div class="col-md-12 col-lg-9 cst-col">
                            ...
                            <div class="create-post-btn-mb">
                                <a href="#createpost"><button type="button" class="btn btn-primary btn-lg create-post-btn">Create a post</button></a>
                            </div>
                            <?php } else {?>
                            <div class="create-post-btn-mb">
                            ...
                            <?php if(!empty($this->session->userdata('login'))){ ?>
                            <a name="createpost"></a>
                            <div class="sidebar-community" style="">
                            ...
                            <div class="new-post-snippet">
                                ...
                                <div class="row ml-4">
                                    <div class="col-sm-12 col-md-4 col-lg-12 mb-4">
                                        <div>
                                            <input type="file" class="post-input" name="fileToUpload[]">
                                        </div>
                                            
                                        <div>
                                            <i class="fas fa-camera"></i> Upload Banner Header OR Video
                                            <p>Note: Only upload banner pictures in jpeg, jpg, png format and Video in mp4 format. Max file size 10MB.</p>
                        ...
                        <div class="col-12">
                            ...
                            <div class="profile-tabs-section"><!-- Profile Tab Section Start -->
                                ...
                                <div class="tabs clearfix" id="tab-3">
                                    ...
                                    <ul class="tab-nav tab-nav2 home-tabs-nav clearfix">
                                        ...
                                        <li class="hidden-phone verified-tab"><a href="#tabs-13" class="feather-tab"></a></li>
                                    </ul>
                                ...
                                <?php 
                                    ...
                                    ?>
                                <script>
                                    var title = "<?php echo addslashes(str_replace('-', ' ', $comm->title)); ?>";
                                ...
                                <div class="row cnt ml-0 mr-0" style="margin-top: 0px;">
                                    <div class="d-flex auth-mb">
                                        <div class="col-md-5 col-lg-5 pl-0 article-img">
                                            <?php if($this->Data_model->isVideo($comm->banner)):?>
                                                <video class="video-tabs-10" id="<?php echo $comm->banner;?>" playsinline loop width="100%" controls>
                                                    <source src="<?php echo base_url('uploads/community/'.$comm->banner); ?>" type="video/mp4">
                                                    Your browser does not support the video tag.
                                                </video> 
                                            <?php else:?>
                                                <img src="<?php echo base_url('uploads/community/'.$comm->banner); ?>" style="" class="mr-2">
                                            <?php endif;?>                                            
                                        </div>
                                    ...
                                    <?php echo $this->pagination->create_links(); ?>
                                        ...
                                        <div class="row cnt ml-0 mr-0" style="margin-top: 0px;">
                                            <div class="d-flex auth-mb">
                                                <div class="col-md-5 col-lg-5 pl-0 article-img">
                                                    <?php if($this->Data_model->isVideo($pop->banner)):?>
                                                        <video class="video-tabs-11" id="<?php echo $pop->banner;?>" playsinline loop width="100%" controls>
                                                            <source src="<?php echo base_url('uploads/community/'.$pop->banner); ?>" type="video/mp4">
                                                            Your browser does not support the video tag.
                                                        </video> 
                                                    <?php else:?>
                                                        <img src="<?php echo base_url('uploads/community/'.$pop->banner); ?>" style="" class="mr-2">
                                                    <?php endif;?>
                                                </div>
                            ...
                            <!--<div class="row cnt ml-0 mr-0">
                                <div class="d-flex auth-mb">
                                    <div class="col-md-5 col-lg-5 pl-0 article-img">
                                        <img src="images/article-img.jpg" class="mr-2">
                                    </div>
                                    
                                    <div class="col-md-7 col-lg-7">
                                        <h3 class="home-article-title pb-0"><a href="">The Power Of Small Time To Talk 2021</a></h3>
                                        <div class="col-md-12 text-center home-arrow">
                                            <div class="post-rating-wrap11">
                                                <i class="fas fa-arrow-up post-rating"></i>
                                                <div class="post-rating-count">80</div>
                                                <i class="fas fa-arrow-down post-rating"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8 home-social-left">
                                            ...
                                            <div class="d-flex post-badge-icons-home mt-3 ml-4 ml-md-0">
                                            <i class="fas fa-award icon-cert icon-cert-badge" data-toggle="tooltip" data-placement="top" title="" data-original-title="If you feel that these posts are brave and bold"> <span class="count" id="brave_count_525"> 0 </span></i>
                                            <i class="fas fa-hand-paper icon-cert icon-cert-raise-hand" data-toggle="tooltip" data-placement="top" title="" data-original-title="150 of these push you to trending page">  <span class="count" id="trending_count_525"> 0 </span></i>
                                            <i class="fas fa-hand-peace icon-cert icon-cert-peace" data-toggle="tooltip" data-placement="top" title="" data-original-title="Posts that bring the community together">  <span class="count" id="together_count_525"> 0 </span></i>
                                            <i class="fas fa-crown icon-cert icon-cert-crown" data-toggle="tooltip" data-placement="top" title="" data-original-title=" High ranking post (300 of them gets it featured on newsletter)"> <span class="count" id="featured_count_525"> 0 </span></i>
                                            <i class="fas fa-trophy icon-cert icon-cert-peace" data-toggle="tooltip" data-placement="top" title="" data-original-title="Honourable mention posts"> <span class="count" id="honourable_count_525"> 0 </span></i>
                                            </div>
                                        
                                            <div class="d-flex mb-3 mb-md-0">
                                                <i class="fas fa-comments post-comment-feature-home ml-3"></i>
                                                <span class="post-features-text ml-2"> 0 </span>

                                                <i class="fas fa-share-alt post-comment-feature-home ml-3"></i>
                                                <span class="post-features-text ml-2"> 0 </span>

                                                <i class="far fa-dot-circle post-comment-feature-home ml-3"></i>
                                                <span class="post-features-text ml-2"> 10 </span>
                                        ...
                                        <div class="col-md-4 home-auth-right">
                                            <div class="home-cmt-user" style="text-align: center;">
                                                <img src="images/auth-image.png" alt="Author" class="rounded-circle mr-2 cmt-img">
                                                    <div>
                                                        <h5 class="mb-0 pb-0 h6 font-weight-semibold" style=""><a class="auth-name" href="#">Aisha Bushell</a></h5>
                                                        <small class="text-muted mb-0 font-weight-normal">3 Feb 2021</small>
                                                    </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row cnt ml-0 mr-0">
                                <div class="d-flex auth-mb">
                                    <div class="col-md-5 col-lg-5 pl-0 article-img">
                                        <img src="images/home-article-2.jpg" class="mr-2">
                                    </div>
                                    
                                    <div class="col-md-7 col-lg-7">
                                        <h3 class="home-article-title pb-0"><a href="">Jeff Bezos: What To Make Of The Amazon CEO</a></h3>
                                        <div class="col-md-12 text-center home-arrow">
                                            <div class="post-rating-wrap11">
                                                <i class="fas fa-arrow-up post-rating"></i>
                                                <div class="post-rating-count">16</div>
                                                <i class="fas fa-arrow-down post-rating"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 home-auth-right">
                                            <div class="home-cmt-user" style="text-align: center;">
                                                <img src="images/auth-image-2.png" alt="Author" class="rounded-circle mr-2 cmt-img">
                                                    <div>
                                                        <h5 class="mb-0 pb-0 h6 font-weight-semibold" style=""><a class="auth-name" href="#">George Arnold</a></h5>
                                                        <small class="text-muted mb-0 font-weight-normal">3 Feb 2021</small>
                                                    </div>
                                            </div>
                                        </div>
...
function vid() {
    if ( document.querySelectorAll('video').length > 0) {
    var videosEl = document.querySelectorAll('video');

    for (var i = 0; i < videosEl.length; i++) {
        var thisVideoEl = videosEl[i];
        thisVideoEl.pause();
    }
  }
}*/
