...
.menu-link{
	...
	<!-- Document Title
	============================================= -->
	<title>Forgot your Password || Spiela</title>
			...
			<div class="spiela-container">
                <div class="login-wrap centered">
                        <div id="normal-header">
                            <h3 class="text-center font-weight-bold"> Forgot your Spiela Account Details</h3>
                    ...
                    <div class="d-flex justify-content-between flex-column login-snippet-wrap">
                        <div>
                            <form action="<?php echo base_url('forgot_password'); ?>" method="POST">
                                ...
                                <button class="btn post-post-button" type="submit" name="forgot">Submit</button>
                            </form>
