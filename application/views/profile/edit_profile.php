...
<head>
    ...
    <title>Edit Profile || Spiela </title>
</head>
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<a href="<?php echo site_url('community/detail/'.$edt_pt->id); ?>" class="btn btn-primary btn-sm back-btn">Go back</a>
					</div>
					<br><br>-->
					
					<form action="<?php echo base_url('profile/update_profile'); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                    <div class="new-post-snippet">
                        <div class="row ml-4">
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-4">
                                <label>First Name</label>
                                <input type="text" class="new-post-title" name="first_name" value="<?php echo $prof->firstname; ?>" />
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-4">
                                <label>Last Name</label>
                                <input type="text" class="new-post-title" name="last_name" value="<?php echo $prof->lastname; ?>" />
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-4">
                                <label>Work Email</label>
                                <input type="email" class="new-post-title" name="work_email" value="<?php echo $prof->work_email; ?>" />
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-4">
                                <label>Date Of Birth</label>
                                <input type="date" class="new-post-title" name="dob" value="<?php echo $prof->dob; ?>" />
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-4">
                                <label>Company Name</label>
                                <input type="text" class="new-post-title" name="company" value="<?php echo $prof->company; ?>" />
                            </div>
                        </div>
                        <div class="row ml-4">
                            <div class="col-sm-10 col-md-11 col-lg-11 col-xl-11 mt-2 mr-4 mr-md-0 mb-5">
                                <label>Bio</label>
                                <textarea id="summernote" class="new-post-textarea mb-4" name="bio"><?php echo $prof->bio; ?></textarea>
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-4">
                                <label>Interest</label>
                                <br>
                                Diversity <input type="checkbox" class="new-post-title" name="interest[]" value="Diversity" style="margin-left: 20px;"><br>
                                Education <input type="checkbox" class="new-post-title" name="interest[]" value="Education" style="margin-left: 12px;"><br>
                                Entertainment <input type="checkbox" class="new-post-title" name="interest[]" value="Entertainment" style="margin-left: -18px;"><br>
                                Entrepeneurship <input type="checkbox" class="new-post-title" name="interest[]" value="Entrepeneurship" style="margin-left: -32px;"><br>
                                Film <input type="checkbox" class="new-post-title" name="interest[]" value="Film" style="margin-left: 50px;"><br>
                                Finance <input type="checkbox" class="new-post-title" name="interest[]" value="Finance" style="margin-left: 27px;"><br>
                                Geopolitics <input type="checkbox" class="new-post-title" name="interest[]" value="Geopolitics" style="margin-left: 5px;"><br>
                                Inclusion <input type="checkbox" class="new-post-title" name="interest[]" value="Inclusion" style="margin-left: 20px;"><br>
                                International <input type="checkbox" class="new-post-title" name="interest[]" value="International" style="margin-left: -5px;"><br>
                                Mental Health <input type="checkbox" class="new-post-title" name="interest[]" value="Mental Health" style="margin-left: -12px;"><br>
                                News <input type="checkbox" class="new-post-title" name="interest[]" value="News" style="margin-left: 44px;"><br>
                                Politics <input type="checkbox" class="new-post-title" name="interest[]" value="Politics" style="margin-left: 32px;"><br>
                                Sports <input type="checkbox" class="new-post-title" name="interest[]" value="Sports" style="margin-left: 38px;"><br>
                                Technology <input type="checkbox" class="new-post-title" name="interest[]" value="Technology" style="margin-left: 5px;"><br>
                                Women <input type="checkbox" class="new-post-title" name="interest[]" value="Women" style="margin-left: 32px;"><br>
                            </div>
                        </div>
                        <div class="row ml-4">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 mb-4">
                                ...
                                <button class="post-post-button ml-3" type="submit" name="edit_profile"> Post</button>
                            </div>
                        </div>
                    </div>
                    </form>
