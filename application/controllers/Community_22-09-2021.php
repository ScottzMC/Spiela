<?php 
    ...
    class Community extends CI_Controller{
        ...
        public function test_view(){
          $config['base_url'] = base_url()."community/test_view";
          $total_row = $this->Data_model->record_community_count();
          $config['total_rows'] = $total_row;
          $config['per_page'] = 25;
          $config['uri_segment'] = 3;
    ...
    <?php }else if(in_array($extension, $allowedExts)){ 
        ...
        if(in_array($extension, $allowedExts)){
          if(isset($_FILES['fileToUpload'])){
            ...
            $query = $this->db->query("SELECT DISTINCT email FROM users")->result();
            ...
            /*foreach($recipients as $mailto) {
                ...
                $message = $this->load->view('massmail', $mailto, TRUE); 
